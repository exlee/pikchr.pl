...
pub(crate) fn icon_image(icon: AppIcon, tint: egui::Color32) -> egui::Image<'static> {
    egui::Image::new(match icon {
        ...
        AppIcon::InsertMode => egui::include_image!("../assets/icons/square-letter-i.svg"),
        AppIcon::ReplaceMode => egui::include_image!("../assets/icons/square-letter-r.svg"),
...
impl AppIcon {
    fn alt_text(self) -> &'static str {
        match self {
            ...
            AppIcon::InsertMode => "Insert mode",
            AppIcon::ReplaceMode => "Replace mode",
